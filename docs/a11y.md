...
- Future game shortcuts, such as queen hint, should be additive shortcuts rather than replacements for focusable buttons.
...
- Prefer configurable shortcuts only for additive game actions, such as using a hint.
